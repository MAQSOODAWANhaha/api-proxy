            ...
            .exec_stmt(
                Query::insert()
                    ...
                    .values_panic([
                        ...
                        r#"{"tokens_prompt":{"type":"direct","path":"usageMetadata.promptTokenCount"},"tokens_completion":{"type":"direct","path":"usageMetadata.candidatesTokenCount"},"tokens_total":{"type":"expression","formula":"usageMetadata.totalTokenCount","fallback":"usageMetadata.promptTokenCount + usageMetadata.candidatesTokenCount"},"cache_create_tokens":{"type":"direct","path":"usageMetadata.cache_creation_tokens"},"cache_read_tokens":{"type":"direct","path":"usageMetadata.cache_read_tokens"}}"#.into(),
