        ...
        manager
            .create_table(
                Table::create()
                    ...
                    // AuthHeaderFormat功能已合并到ConfigJson中
                    .col(
