        ...
        manager
            .exec_stmt(
                Query::insert()
                    ...
                    // OpenAI配置 - 支持API Key和OAuth2认证，兼容Chat Completion和Realtime API
                    .values_panic([
                        "openai".into(),
                        "OpenAI ChatGPT".into(),
                        "chatgpt.com".into(),
                        ...
                        r#"{"tokens_prompt":{"type":"direct","path":"usage.input_tokens","fallback":{"type":"direct","path":"usageMetadata.promptTokenCount"}},"tokens_completion":{"type":"direct","path":"usage.output_tokens","fallback":{"type":"direct","path":"usageMetadata.candidatesTokenCount"}},"tokens_total":{"type":"direct","path":"usage.total_tokens","fallback":{"type":"expression","formula":"usageMetadata.totalTokenCount","fallback":{"type":"expression","formula":"usageMetadata.promptTokenCount + usageMetadata.candidatesTokenCount"}}},"cache_create_tokens":{"type":"direct","path":"usage.input_tokens_details.cache_creation_tokens","fallback":{"type":"direct","path":"usageMetadata.cache_creation_tokens"}},"cache_read_tokens":{"type":"direct","path":"usage.input_tokens_details.cached_tokens","fallback":{"type":"direct","path":"usageMetadata.cache_read_tokens"}}}"#.into(),
                        ...
                        r#"{"api_key": {}, "oauth": {"client_id": "app_EMoamEEZ73f0CkXaXp7hrann", "authorize_url": "https://auth.openai.com/oauth/authorize", "token_url": "https://auth.openai.com/oauth/token", "redirect_uri": "http://localhost:1455/auth/callback", "scopes": "openid profile email offline_access", "pkce_required": true, "extra_params": {"response_type": "code", "id_token_add_organizations": "true", "codex_cli_simplified_flow": "true", "originator": "codex_cli_rs"}}}"#.into(),
                    ])
                    ...
                    .values_panic([
                        ...
                        r#"{"request_stage":{"required_headers":{}},"response_stage":{}}"#.into(),
                        r#"{"tokens_prompt":{"type":"direct","path":"usageMetadata.promptTokenCount","fallback":{"type":"direct","path":"usage.prompt_tokens"}},"tokens_completion":{"type":"direct","path":"usageMetadata.candidatesTokenCount","fallback":{"type":"direct","path":"usage.completion_tokens"}},"tokens_total":{"type":"expression","formula":"usageMetadata.totalTokenCount","fallback":{"type":"expression","formula":"usageMetadata.promptTokenCount + usageMetadata.candidatesTokenCount"}},"cache_create_tokens":{"type":"direct","path":"usageMetadata.cache_creation_tokens","fallback":{"type":"direct","path":"usage.prompt_tokens_details.cached_tokens"}},"cache_read_tokens":{"type":"direct","path":"usageMetadata.cache_read_tokens","fallback":{"type":"direct","path":"usage.cached_tokens"}}}"#.into(),
