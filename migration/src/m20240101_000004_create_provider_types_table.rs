            ...
            .exec_stmt(
                Query::insert()
                    ...
                    .values_panic([
                        ...
                        r#"{"api_key": {}, "oauth2": {"client_id": "ANTHROPIC_CLIENT_ID_PLACEHOLDER", "client_secret": "ANTHROPIC_CLIENT_SECRET_PLACEHOLDER", "authorize_url": "https://console.anthropic.com/oauth/authorize", "token_url": "https://console.anthropic.com/oauth/token", "scopes": "openid profile api:inference api:manage", "pkce_required": true, "response_type": "code", "grant_type": "authorization_code", "access_type": "offline", "prompt": "consent"}}"#.into(),
                    ])
                    .to_owned(),
            )
            .await?;
