            ...
            .exec_stmt(
                Query::insert()
                    ...
                    .values_panic([
                        ...
                        r#"{"api_key": {}, "oauth2": {"client_id": "app_EMoamEEZ73f0CkXaXp7hrann", "authorize_url": "https://auth.openai.com/oauth/authorize", "token_url": "https://auth.openai.com/oauth/token", "redirect_uri": "https://auth.openai.com/oauth/callback", "scopes": "openid profile email", "pkce_required": true, "response_type": "code", "grant_type": "authorization_code"}}"#.into(),
                    ])
