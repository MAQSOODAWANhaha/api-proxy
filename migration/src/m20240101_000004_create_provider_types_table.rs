            ...
            .exec_stmt(
                Query::insert()
                    ...
                    .values_panic([
                        ...
                        r#"{"api_key": {}, "oauth": {"client_id": "app_EMoamEEZ73f0CkXaXp7hrann", "authorize_url": "https://auth.openai.com/oauth/authorize", "token_url": "https://auth.openai.com/oauth/token", "redirect_uri": "https://auth.openai.com/oauth/callback", "scopes": "openid profile email offline_access", "pkce_required": true, "response_type": "code", "grant_type": "authorization_code", "extra_params": {"id_token_add_organizations": "true", "codex_cli_simplified_flow": "true"}}}"#.into(),
                    ])
                    ...
                    .values_panic([
                        ...
                        r#"{"api_key": {}, "oauth": {"client_id": "9d1c250a-e61b-44d9-88ed-5944d1962f5e", "authorize_url": "https://claude.ai/oauth/authorize", "token_url": "https://console.anthropic.com/v1/oauth/token", "redirect_uri": "https://console.anthropic.com/oauth/code/callback", "scopes": "user:inference", "pkce_required": true, "response_type": "code", "grant_type": "authorization_code", "extra_params": {"code": "true"}}}"#.into(),
                    ])
                    .to_owned(),
            )
            .await?;
