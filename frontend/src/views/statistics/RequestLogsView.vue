...
.logs-filters .el-form-item:last-child {
  margin-right: 0;
}

.logs-filters .el-select {
  width: 160px;
}
...
.logs-filters .el-date-editor {
  width: 350px;
}

.logs-filters .el-button {
  margin-left: 8px;
}

.logs-filters .el-button:first-child {
  margin-left: 0;
}
...
:deep(.table-container .el-table__row) {
  cursor: pointer;
}
