  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[760px]">
        <DialogHeader>
          <DialogTitle>{isEdit ? '编辑服务商类型' : '新增服务商类型'}</DialogTitle>
        </DialogHeader>
        ...
        <div className="mt-2 grid grid-cols-1 gap-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <Input value={form.name} onChange={(e) => setField('name', e.target.value)} placeholder="例如 openai" />
            </div>
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Input value={form.display_name} onChange={(e) => setField('display_name', e.target.value)} placeholder="例如 OpenAI ChatGPT" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Input value={form.base_url} onChange={(e) => setField('base_url', e.target.value)} placeholder="例如 api.openai.com" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea value={form.config_json} onChange={(e) => setField('config_json', e.target.value)} rows={4} placeholder="可选，JSON 对象" />
          </div>

          <div className="space-y-2">
            <Label>token_mappings_json</Label>
            <Textarea value={form.token_mappings_json} onChange={(e) => setField('token_mappings_json', e.target.value)} rows={6} placeholder="可选，JSON 对象" />
          </div>

          <div className="space-y-2">
            <Label>model_extraction_json</Label>
            <Textarea value={form.model_extraction_json} onChange={(e) => setField('model_extraction_json', e.target.value)} rows={6} placeholder="可选，JSON 对象" />
          </div>

          <div className="space-y-2">
            <Label>auth_configs_json</Label>
            <Textarea value={form.auth_configs_json} onChange={(e) => setField('auth_configs_json', e.target.value)} rows={8} placeholder="API Key 行可为空对象 {}；OAuth 行为配置对象" />
          </div>
        </div>
